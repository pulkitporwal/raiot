...
function verifyGeoLocation(req, res, next) {
    try {
        ...
        const clubLatitude = 26.9167; // Get club's latitude from database or hardcoded value
        const clubLongitude = 75.8121; // Get club's longitude from database or hardcoded value
