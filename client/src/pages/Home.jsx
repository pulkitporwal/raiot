	...
	return (
		...
		>
			...
			<section className="w-full absolute top-48 text-center">
				...
				<Link to={"/signup"} className="button w-[110px] mt-10">
					Register
				</Link>
			</section>
				...
				<p className=" text-2xl mt-10 font-normal paragraph-gradient">
					<div>
						...
						<p className="text-[#aaaf9e] text-base mb-5">
							Dive into practical, real-world applications of
							robotics through our hands-on projects. From
							building simple robots to tackling complex
							challenges, our club provides a platform for you to
							apply theoretical knowledge to tangible creations.
						</p>
						<h2 className="text-white text-2xl">
							<span>2. Workshops and Training:</span>
						</h2>
						<p className="text-[#aaaf9e] text-base mb-5">
							Stay at the forefront of robotics technology with
							our workshops and training sessions. Led by
							experienced members and invited experts, these
						...
						<p className="text-[#aaaf9e] text-base mb-5">
							Put your skills to the test by participating in
							local and national robotics competitions. Our club
							actively seeks opportunities for members to showcase
							their talents and compete against other robotics
							enthusiasts.
						</p>
						<h2 className="text-white text-2xl">
						...
						<p className="text-[#aaaf9e] text-base mb-5">
							...
							through guest speaker events. Learn about the latest
							trends, advancements, and career opportunities in
							robotics, and expand your network within the
							robotics community.
						</p>
						<h2 className="text-white text-2xl">
						...
						<p className="text-[#aaaf9e] text-base mb-5">
							We believe in giving back to the community. Engage
							in outreach programs where we use robotics as a tool
							to inspire and educate others. Whether it's hosting
							robotics workshops for local schools or
							participating in community events, we strive to make
							a positive impact.
						</p>
					</div>
				</p>
			...
			>
				...
				<p className="mt-10 font-normal paragraph-gradient text-3xl">
					...
					<p className="text-[#aaaf9a] text-sm">
						No Previous Experience Is Necessary, But is appreciated.
						But enthusiasm to Learn Is Compulsory.
					</p>
				</p>
				<p className="mt-10 font-normal paragraph-gradient text-3xl">
					<span className="font-bold ">
					...
					<p className="text-[#aaaf9a] text-sm">
						Only Students of Amity University Can Join as per
				...
				<p className="mt-10 font-normal paragraph-gradient text-3xl">
					...
					<p className="text-[#aaaf9a] text-sm">
						You Must at least have a portable device that you can
						carry to the lab, on which you can code.
					</p>
				</p>
			</section>
			...
			<section className="absolute w-[99.99%] h-[60vh] md:h-[40vh] sm:h-[80vh] text-white bg-[#050505] text-center top-[460vh] sm:top-[530vh] px-5 sm:px-48 bg-center bg-cover">
				...
				<hr className="mt-12" />
				<p className="text-gray-500 mt-3 text-base">© 2023 RaIoT. All rights reserved.</p>
			</section>
		</div>
	);
};
