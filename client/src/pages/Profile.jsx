...
const Profile = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("https://raiot-1.onrender.com/api/user/update-information", {
        method: "POST",
        credentials: "include",
        body: formDataToSend
      });
  ...
  return (
    <div className="sm:ml-[250px] min-h-[99vh] px-10 py-10 flex items-center justify-center flex-col">
      ...
      <div className="bg-[#fafafa] py-10 hover:-translate-y-2 transition-all duration-75 ease-linear w-full rounded-2xl shadow-lg min-h-[85vh] h-full">
        ...
        <div className="flex items-center justify-center flex-col md:flex-row gap-x-36 mt-8 px-32 ">
