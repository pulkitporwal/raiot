		...
		<>
			...
			*/}{" "}
										...
										<div className="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
											...
											>
												...
												<div className="ml-4">
													...
													<p className="mt-1 text-sm text-gray-500">
														See what meet-ups and
														other events we might be
														planning near you.
													</p>
												</div>
											</a>
						...
						<div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
							<a
								href="#"
								className="whitespace-nowrap text-base font-medium text-white px-4 py-2 hover:bg-black transition-all rounded-md"
							>
								Sign in
							</a>
							<a
								href="#"
								className="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-black hover:border-black"
							>
								Sign up
							</a>
						</div>
